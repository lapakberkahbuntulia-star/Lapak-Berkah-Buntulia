...
const products = [
  { id: 1, name: 'Nasi Kuning', sku: 'BRP-001', category: 'Perishable', type: 'Makanan Basah', mitraName: 'Toko Makmur', mitraPrice: 14500, sellingPrice: 18000, stock: 45, unit: 'Pcs', barcodeId: 'BC-001' },
  { id: 2, name: 'Kerupuk', sku: 'MNG-002', category: 'Non-Perishable', type: 'Makanan Kering', mitraName: 'Grosir Jaya', mitraPrice: 2000, sellingPrice: 3500, stock: 120, unit: 'Pack', barcodeId: 'BC-002' },
  { id: 3, name: 'Es Teh Manis', sku: 'GLP-003', category: 'Perishable', type: 'Minuman', mitraName: 'Toko Harapan', mitraPrice: 3000, sellingPrice: 5000, stock: 0, unit: 'Gelas', barcodeId: 'BC-003' },
  { id: 4, name: 'Susu UHT 250ml', sku: 'MIG-004', category: 'Non-Perishable', type: 'Minuman', mitraName: 'Toko Makmur', mitraPrice: 5500, sellingPrice: 8000, stock: 24, unit: 'Karton', barcodeId: 'BC-004' },
  { id: 5, name: 'Mie Instan Goreng', sku: 'SUS-005', category: 'Non-Perishable', type: 'Makanan Kering', mitraName: 'Grosir Jaya', mitraPrice: 3000, sellingPrice: 4500, stock: 120, unit: 'Pcs', barcodeId: 'BC-005' },
  { id: 6, name: 'Kopi Susu Gula Aren', sku: 'KOP-006', category: 'Perishable', type: 'Minuman', mitraName: 'Toko Makmur', mitraPrice: 8000, sellingPrice: 12000, stock: 50, unit: 'Gelas', barcodeId: 'BC-006' },
];
                    ...
                    {filteredProducts.map((product, idx) => {
                      ...
                      return (
                        ...
                        >
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <div className="font-body-sm text-body-sm text-on-surface-variant mt-0.5">Rp {product.sellingPrice.toLocaleString('id-ID')}</div>
                              </div>
                            </div>
                          </td>
                          <td className="px-6 py-4">
                          ...
                          <td className="px-6 py-4">
                            <span className="font-mono text-sm bg-surface-container px-2 py-1 rounded-md text-on-surface-variant">{product.barcodeId}</span>
                          </td>
                        </tr>
                      );
                    })}
